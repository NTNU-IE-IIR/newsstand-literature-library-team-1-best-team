...
public class Register {
    ...
    public void addLiteratureToRegister(String title, String publisher, String publishedDate, String price, String currency, String typeOfLiterature) {
        addLiterature(new Literature(title, publisher, publishedDate, price, currency, typeOfLiterature) {
        });
    }
    ...
    */
    ...
    public void addLiteratureToList() {
        ...
        Literature Donald_duck = new Magazine("Donald duck", "Egmont", "27.04.28", "50", "kr", "magazine");
        Literature KK = new Magazine("KK", "Egmont", "07.08.17", "2000", "kr", "magazine");
        ...
        Literature Krim_og_mord = new Book("Krim", "krimmens gangs", "03.03.13", "300", "kr", "book");
