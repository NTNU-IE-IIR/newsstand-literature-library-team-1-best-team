...
public class AES {
    ...
    public static String encrypt(String encryptionKey, String nonce, String value){
        try {
            ...
            IvParameterSpec initVector = new IvParameterSpec(decoder.decode(nonce));
            // makes an encryption key for the AES algorithm form the provided key
            SecretKeySpec secretKeySpec = new SecretKeySpec(decoder.decode(encryptionKey), encryptionAlgorithm);
    ...
    public static String decrypt(String encryptionKey, String nonce, String value){
        try {
            ...
            // encrypts the given value
            byte[] decrypted = cipher.doFinal(DatatypeConverter.parseBase64Binary(value));
